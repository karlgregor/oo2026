...
function findCheapestHour(prices) {
...
function findCheapestHours(prices, hours) {
    ...
    return { hours: result, averagePrice: averagePrice };
}
// Run + outputs
...
console.log("Cheapest", hoursOfUsage, "hours:", cheapestHours.hours.map(function (h) { return h + ":00"; }), "with the average price of", cheapestHours.averagePrice.toFixed(2), "cents per kWh");
